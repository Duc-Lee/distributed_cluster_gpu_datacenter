...
def build_arrivals(inf_mode='sinusoid', inf_rate=6.0, inf_amp=0.6, inf_period=300.0,
                   trn_mode='poisson', trn_rate=0.3, inf_trace=None, trn_trace=None):
    arrival_inf = ArrivalConfig(mode=inf_mode, rate=inf_rate, amp=inf_amp, period=inf_period, trace_path=inf_trace)
    arrival_trn = ArrivalConfig(mode=trn_mode, rate=trn_rate, trace_path=trn_trace)
