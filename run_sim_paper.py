...
def parse_args():
    ...
    p.add_argument(
        ...
        choices=["poisson", "sinusoid", "off", "trace"],
    ...
    p.add_argument("--inf-trace", type=str, default=None, help="Đường dẫn file trace cho inference.")
    p.add_argument("--trn-trace", type=str, default=None, help="Đường dẫn file trace cho training.")
...
def main():
    ...
    arrival_inf, arrival_trn = build_arrivals(inf_mode=args.inf_mode, inf_rate=args.inf_rate,
                                              ...
                                              inf_trace=args.inf_trace, trn_trace=args.trn_trace)
